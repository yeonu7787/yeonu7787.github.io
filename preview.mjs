...
const files = {'/personal-theme.css':'personal-theme.css','/post-format.js':'post-format.js','/questions/':'questions/index.html','/questions.js':'questions.js','/account/':'account/index.html','/community.js':'community.js','/editor-kit.js':'editor-kit.js','/reference-theme.css':'reference-theme.css','/sidebar.js':'sidebar.js','/write/':'write/index.html','/write':'write/index.html','/auth.js':'auth.js','/admin':'admin/index.html','/admin/':'admin/index.html','/blog':'blog/index.html','/blog/':'blog/index.html','/blog-view.js':'blog-view.js','/posts.js':'posts.js','/supabase-config.js':'supabase-config.js','/':'index.html','/index.html':'index.html','/app.js':'app.js','/content.js':'content.js','/style.css':'style.css'};
createServer(async(req,res)=>{
 const path=new URL(req.url,'http://localhost').pathname;
 if(path==="/admin"||path==="/blog"||path==="/write"||path==="/account"||path==="/questions"){res.writeHead(301,{Location:path+"/"});res.end();return;}
