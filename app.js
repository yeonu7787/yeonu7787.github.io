...
function route() {
 ...
 if(name==="home"){
  ...
  main.innerHTML='<div class="eyebrow">About me</div><h1>About / CV</h1><p class="prose biography">'+esc(profile.biography)+'</p>'+
  ...
  (profile.email?'<section class="cv-section"><h2>Contact</h2><a class="text-link" href="mailto:'+esc(encodeURIComponent(profile.email))+'">'+esc(profile.email)+'</a></section>':'');
 }else{
